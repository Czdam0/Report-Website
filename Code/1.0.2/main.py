...
def Report(url):
    ...
    checknext(pymsgbox.confirm('Continue?', 'continue?', ["continue", 'stop']))
    webbrowser.open_new_tab("https://www.abuseipdb.com/report")
    checknext(pymsgbox.confirm('Continue?', 'continue?', ["continue", 'stop']))
    ...
    checknext(pymsgbox.confirm('Continue?', 'continue?', ["continue", 'stop']))
    webbrowser.open_new_tab("https://www.malwareurl.com/listing-urls.php")
    checknext(pymsgbox.confirm('Continue?', 'continue?', ["continue", 'stop']))
    webbrowser.open_new_tab("https://urlhaus.abuse.ch/browse/")
    checknext(pymsgbox.confirm('Continue?', 'continue?', ["continue", 'stop']))
    webbrowser.open_new_tab("https://badbitcoin.org/report/")
    checknext(pymsgbox.confirm('Continue?', 'continue?', ["continue", 'stop']))
    webbrowser.open_new_tab("https://www.urlvoid.com/")
    checknext(pymsgbox.confirm('Continue?', 'continue?', ["continue", 'stop']))
    ...
    checknext(pymsgbox.confirm('Continue?', 'continue?', ["continue", 'stop']))
    webbrowser.open_new_tab("https://discord.gg/zjsubxNEnj")
    checknext(pymsgbox.confirm('Continue?', 'continue?', ["continue", 'stop']))
    webbrowser.open_new_tab("https://reporting.actionfraud.police.uk/reporting")
